...
> **现状：** ED0–ED5 代码已写。默认内容路径仍是外部 DCC + CLI。  
...
| 口径 | 含义 | 本层状态 |
|---|---|---|
| **摆放器可用** | 打开场景、点选变换、场景树/检视、保存后 Runtime 可读 | **代码已写，未测**（ED0–ED3） |
| **编辑器可用** | + Play-in-Editor、暂停、Prefab 放置、脚本字段 | **ED4–ED5 已写** |
...
> 下列在主流里是开箱能力；本层 **ED0–ED3 代码已写、未测**。  
