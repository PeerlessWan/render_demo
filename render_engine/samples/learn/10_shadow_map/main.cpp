...
void AddScene(engine::Application& a) {
...
int main(int argc, char** argv) {
  ...
  desc.window.title = "Learn 10 — Shadow Map";
  ...
  env.sun_direction = {0.4f, -1.f, 0.3f};
  env.sun_intensity = 2.2f;
  ...
  engine::LogInfo("Shadows on, cascade_count=" + std::to_string(render.cascade_count()));
